...
function addUnitTypeIcon(a, holder, origin) {
    ...
    for (j in jsonUnitAbilities) {
        if (a === jsonUnitAbilities[j].slug) {
            ...
            spa.innerHTML = "<img style=\"float:left; height:30px; width:30px\" src=\"/evolved/Icons/Abilities/" + iconsrc + ".png\"><p class=\"abilityHighLighter\" style=\"color: #d7c297;>" + "<span  style=\"font-size=20px;\">" + iconName + "</span></p>" +
                "</br>" + icontext;
            iconName = jsonUnitAbilities[j].name;
        ...
        if (a === jsonUnits[i].id) {
            ...
            if (keepgoing && !stopHere) {
                ...
                if (CheckIfFormUnit(a)) {
                    ...
                    span.innerHTML = "<img style=\"float:left; height:30px; width:30px\" src=\"/evolved/Icons/FactionCreation/human.png\"><p style=\"color: #d7c297\" class=\"abilityHighLighter\">" + "<span style=\"font-size=20px;\">FORM UNIT</span></p>" +
...
function backtrackUnitOrigins(unitData, name, holder) {
    ...
    if (unitAbility != "") {
        ...
        const imgSrc = unitAbility[0] != "" ? `/evolved/Icons/Abilities/${unitAbility[1].icon}.png` : `/evolved/Icons/HeroSkillIcons/${unitAbility[1].icon}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
    ...
    if (heroSkill != "") {
        ...
        const imgSrc = heroSkill[0] != "" ? `/evolved/Icons/Abilities/${heroSkill[0].icon}.png` : `/evolved/Icons/HeroSkillIcons/${heroSkill[1].icon}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
    ...
    if (evolve != "") {
        ...
        const imgSrc = `/evolved/Icons/Abilities/evolve.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
