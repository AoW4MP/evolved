...
const errorImage = "/evolved/Icons/Text/exclamationpoint.png";
...
function ShowUnitFromLink() {
    ...
    document.title = "Age of Wonders 4 Evolved - " + unitNameLoc.name;
...
function addResistanceSlot(a, resistance, defense, holder) {
    ...
    if (a.indexOf("Physical") !== -1) {
        imag.setAttribute("src", "/evolved/Icons/Text/physical_resistance.png");
...
function showUnit(unitID, subcultureCheck, resID, divOrigin) {
    ...
    if ("combat_speed" in unitEN) {
        ...
        img.setAttribute("src", "/evolved/Icons/Text/combat_speed.png");
...
function backtrackUnitOrigins(unitData, name, holder) {
    ...
    for (let x = 0; x < tomes.length; x++) {
        ...
        const imgSrc = `/evolved/Icons/TomeIcons/${tomes[x].icon}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
        const link = `/evolved/HTML/Spells.html?tome=${tomes[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < spells.length; x++) {
        ...
        // const imgSrc = `/evolved/Icons/SpellIcons/${imageLinkName}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
    ...
    for (let x = 0; x < siege.length; x++) {
        ...
        const imgSrc = `/evolved/Icons/SiegeProjectIcons/${siege[x].icon}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
        const link = `/evolved/HTML/Spells.html?siege=${siege[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < traitFound.length; x++) {
        ...
        const imgSrc = `/evolved/Icons/FactionCreation/${traitFound[x].id}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
        const link = `/evolved/HTML/Spells.html?trait=${traitFound[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < wonder.length; x++) {
        ...
        const imgSrc = `/evolved/Icons/StructurePics/${wonder[x].id}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
    ...
    for (let x = 0; x < tree.length; x++) {
        ...
        const imgSrc = `/evolved/Icons/EmpireProgressionIcons/${tree[x].icon}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
    ...
    for (let x = 0; x < unitAbility.length; x++) {
        ...
        const imgSrc =
            unitAbility[0] != ""
                ? `/evolved/Icons/UnitIcons/${unitAbility[x][1].icon}.png`
                : `/evolved/Icons/UnitIcons/${unitAbility[x][1].icon}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
        const link = `/evolved/HTML/Units.html?unit=${unitAbility[x][0].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < infusion.length; x++) {
        ...
        const imgSrc = `/evolved/Icons/UnitIcons/` + infusion[x].icon + `.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
        const link = `/evolved/HTML/Infusions.html`;
        const miniIcon = document.createElement("div");
        miniIcon.className = "MiniIconCheck";
    ...
    for (let x = 0; x < heroSkill.length; x++) {
        ...
        const imgSrc = `/evolved/Icons/UnitIcons/${heroSkill[x].icon}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
        const link = `/evolved/HTML/Spells.html?skill=${heroSkill[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < governance.length; x++) {
        ...
        const imgSrc = `/evolved/Icons/GovernanceIcons/${governance[x].icon}.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
        const link = `/evolved/HTML/Spells.html?governance=${governance[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    if (evolve != "") {
        ...
        const imgSrc = `/evolved/Icons/Text/evolve.png`;
        const imgFallbackSrc = `/evolved/Icons/Text/mp.png`;
...
function showSiegeProject(id, showOrigin, divOrigin) {
    ...
    populateGenericCard(divOrigin, {
        ...
        icon: "/evolved/Icons/SiegeProjectIcons/" + siegeProject.icon + ".png"
    });
...
function showEmpireUpgrade(skill, showOrigin, divOrigin) {
    ...
    let imageLinkName = skill.name.replaceAll(" ", "_").toLowerCase();
    imagelink.setAttribute("src", "/evolved/Icons/ExtraIcons/" + imageLinkName + ".png");
...
function showRelic(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/evolved/Icons/RelicIcons/" + relic.icon + ".png");
...
function showWorldStructure(a, divOrigin) {
    ...
    if (structure.type.indexOf("wonder") != -1) {
        ...
        imagelink.setAttribute("src", "/evolved/Icons/Interface/Header/Infestation.png");
        imagelink.setAttribute("style", "background-image: none");
    } else {
...
function showEmpireTree(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/evolved/Icons/EmpireProgressionIcons/" + treeEntry.icon + ".png");
...
function showUnitUnlock(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/evolved/Icons/UnitUnlockIcons/" + a.unit_slug + ".png");
...
function backtraceTomeOriginAndTier(spell, showorigin, modCard) {
    ...
    if (artifactSpells != undefined) {
        if (showorigin) {
            ...
            const tomeOriginIcon = modCard.querySelector("#originTomeIcon");
            tomeOriginIcon.setAttribute("src", "/evolved/Icons/RelicIcons/" + artifactSpells.icon + ".png");
            const wrap = tomeOriginName.innerHTML;
    ...
    if (worldStructureSpells != undefined) {
        if (showorigin) {
            ...
            const tomeOriginIcon = modCard.querySelector("#originTomeIcon");
            tomeOriginIcon.setAttribute("src", "/evolved/Icons/StructurePics/" + worldStructureSpells.id + ".png");
            const wrap = tomeOriginName.innerHTML;
             if(worldStructureSpells.type == "Landmark"){
                   tomeOriginName.innerHTML = '<a href="/evolved/HTML/Landmarks.html">' + wrap + "</a>";
            } else{
                     tomeOriginName.innerHTML = '<a href="/evolved/HTML/AncientWonders.html">' + wrap + "</a>";
            }
    ...
    if (worldStructureSpellsReward != undefined) {
        if (showorigin) {
            ...
            const tomeOriginIcon = modCard.querySelector("#originTomeIcon");
            tomeOriginIcon.setAttribute("src", "/evolved/Icons/StructurePics/" + worldStructureSpellsReward.id + ".png");
            const wrap = tomeOriginName.innerHTML;
             if(worldStructureSpellsReward.type == "Landmark"){
                   tomeOriginName.innerHTML = '<a href="/evolved/HTML/Landmarks.html">' + wrap + "</a>";
            } else{
  ...
  let ascendedSpellsName = findBy(jsonHeroSkills, "id",  ascendedSpells.id);
            ...
            const tomeOriginIcon = modCard.querySelector("#originTomeIcon");
            tomeOriginIcon.setAttribute("src", "/evolved/Icons/UnitIcons/" + ascendedSpellsName.icon + ".png");
             const wrap = tomeOriginName.innerHTML;
            tomeOriginName.innerHTML =
                '<a href="/evolved/HTML/HeroSkills.html">' + wrap + "</a>";
    ...
    if (ExtraSpellsLookup != undefined) {
        if (showorigin) {
            ...
            const tomeOriginIcon = modCard.querySelector("#originTomeIcon");
            tomeOriginIcon.setAttribute("src", "/evolved/Icons/" + ExtraSpellsLookup.icon + ".png");
            // const wrap = tomeOriginName.innerHTML;
            // tomeOriginName.innerHTML =
            //     '<a href="/evolved/HTML/Landmarks.html">' + wrap + "</a>";
