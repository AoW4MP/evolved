...
function ClearAscensionSkill() {
    ...
    ascensionHolder.innerHTML =
        "<img class='padded-image' src='/evolved/Icons/Interface/addsymbol.png' height='20px' />";
    currentAscension = "";
}
...
function selectTomePath(origin, fromLoad) {
    ...
    addSlot.innerHTML = "<img src='/evolved/Icons/Interface/addsymbol.png' height='20px' />";
...
function SetTomePathInfoSmall(buttonHolder, origin, index, isInvalid) {
    ...
    image.src = "/evolved/Icons/TomeIcons/" + origin.icon + ".png"; // Set the image source to your image file
    ...
    if (index > 0) {
        ...
        removeBtn.innerHTML = "<img src='/evolved/Icons/Interface/CloseX.png' height='15px' />";
...
function createImage(type, origin) {
    ...
    switch (type) {
        case "Tome":
            setImage(`/evolved/Icons/TomeIcons/${origin.icon}.png`);
            break;
        case "Society1":
        case "Society2":
        case "FormTrait":
        ...
        case "Ascension":
            ...
            break;
        case "Ambition":
            setImage(`/evolved/Icons/AmbitionIcons/${origin.icon}.png`);
            break;
        /* case "Symbol":
...
function getFactionIconPath(id) {
    ...
    return `/evolved/Icons/FactionCreation/${cleanId}.png`;
}
        ...
        for (let index = 0; index < origin.skills.length; index++) {
            ...
            if (
                ...
                if ("spell_slug" in origin.skills[index]) {
                    ...
                    span.innerHTML +=
                        '<bullet> <img width="20px" src="/evolved/Icons/UnitUnlockIcons/' +
    ...
    for (let index = 0; index < list.length; index += 2) {
        ...
        for (let i = 0; i < jsonSiegeProjects.length; i++) {
            ...
            if (jsonSiegeProjects[i].id == slug) {
                ...
                text.innerHTML = loc.name;
                var smallIcon = document.createElement("img");
                smallIcon.setAttribute("src", "/evolved/Icons/SiegeProjectIcons/" + jsonSiegeProjects[i].icon + ".png");
                smallIcon.setAttribute("width", "20px");
                spell.appendChild(smallIcon);
                spell.appendChild(text);
                section.append(spell);
