...
function SetSkillPathInfoSmall(buttonHolder, origin) {
    ...
    image.src = "/evolved/Icons/Abilities/" + origin.icon + ".png"; // Set the image source to your image file
...
function SetButtonInfo(button, origin, type, color) {
    ...
    if (type === "Tome") {
        ...
        image.src = "/evolved/Icons/Abilities/" + origin.id + ".png"; // Set the image source to your image file
    } else if (type === "Signature" || type == "Ascension") {
        image.src = "/evolved/Icons/Abilities/" + origin.icon + ".png";
    } else if (type === "Symbol") {
        if (origin < 10 && origin > 0) {
        ...
        for (let index = 0; index < origin.items.length; index++) {
            ...
            for (let i = 0; i < jsonHeroItems.length; i++) {
                ...
                if (origin.items[index].slug == test.id) {
                    ...
                    span.innerHTML += "<p class =\"abilityHighLighter\" style=\"color: #97d7a2;>" + "<span style=\"font-size=20px;\"> ITEM: <img style=\"margin-top:-10px\" src=\"/evolved/Icons/Abilities/" + test.icon + ".png\" height='30px'>" + test.name.toUpperCase() + "</p>" + "<br>";
                    break;
                }
            ...
            if (origin.items[index].slug == "hero_mount") {
                span.innerHTML += "<p class =\"abilityHighLighter\" style=\"color: #97d7a2;>" + "<span style=\"font-size=20px;\"> ITEM: <img style=\"margin-top:-10px\" src=\"/evolved/Icons/Abilities/white_horse.png\" height='30px'>HERO MOUNT</p>" + "<br>";
        ...
        for (let index = 0; index < origin.spells.length; index++) {
            ...
            for (let i = 0; i < jsonSpells.length; i++) {
                ...
                if (origin.spells[index].slug == test.id) {
                    ...
                    span.innerHTML += "<p class =\"abilityHighLighter\" style=\"color: #82a3eb;>" + "<span style=\"font-size=20px;\"> SPELL: <img style=\"margin-top:-10px\" src=\"/evolved/Icons/SpellIcons/" + test.id + ".png\" height='30px'>" + test.name.toUpperCase() + "</p>" + "<br>";
...
function SetTomePreview(span, origin) {
    ...
    if ('initial_upgrades' in origin) {
        ...
        for (let index = 0; index < origin.initial_upgrades.length; index++) {
            ...
            span.innerHTML += "<bullet> <img width=\"20px\" src=\"/evolved/Icons/UpgradeIcons/" + origin.initial_upgrades[index].upgrade_slug + ".png\">" + GetStructureName(origin.initial_upgrades[index].upgrade_slug) + "</bullet>";
        ...
        for (let index = 0; index < origin.skills.length; index++) {
            ...
            if (origin.skills[index].type == ("<hyperlink>Unit</hyperlink>") || origin.skills[index].type == "Unit Unlock") {
                ...
                if ('spell_slug' in origin.skills[index]) {
                    span.innerHTML += "<bullet> <img width=\"20px\" src=\"/evolved/Icons/SpellIcons/" + origin.skills[index].spell_slug + ".png\">" + GetSpellTierAndName(origin.skills[index].spell_slug) + "</bullet>";

                } else {
                    span.innerHTML += "<bullet> <img width=\"20px\" src=\"/evolved/Icons/SpellIcons/" + origin.skills[index].unit_slug + ".png\">" + GetUnitNamePlain(origin.skills[index].unit_slug) + "</bullet>";
            ...
            // siege
                ...
                span.innerHTML += "<bullet> <img width=\"20px\" src=\"/evolved/Icons/SiegeIcons/" + slug + ".png\">" + GetSiegeProjectName(slug) + "</bullet>";

            }
            // city structure
            else if (origin.skills[index].type.indexOf("Structure") != -1) {
                span.innerHTML += "<bullet> <img width=\"20px\" src=\"/evolved/Icons/UpgradeIcons/" + origin.skills[index].upgrade_slug + ".png\">" + GetStructureName(origin.skills[index].upgrade_slug) + "</bullet>";

            }
            // empire upgrades
            else if (origin.skills[index].type.indexOf("Empire") != -1) {
                var imageLinkName = origin.skills[index].name.replaceAll(" ", "_").toLowerCase();
                span.innerHTML += "<bullet> <img width=\"20px\" src=\"/evolved/Icons/SpellIcons/" + imageLinkName + ".png\">" + origin.skills[index].name + "</bullet>";
...
function CreateUnitIcon(listEntry, colorEntry) {
    ...
    allAbilities.innerHTML += "<span style=\"font-size: 20px ;display:flex\" ><img  src=\"/evolved/Icons/Text/health.png\" width=\"25 \" height=\"25 \">" + listEntry.hp +
        "<img src=\"/evolved/Icons/Text/mp.png\" width=\"25 \" height=\"25 \">" + listEntry.mp
        + "<img src=\"/evolved/Icons/Text/resistance.png\" width=\"25 \" height=\"25 \">" + listEntry.resistance +
        "<img  src=\"/evolved/Icons/Text/armor.png\" width=\"25 \" height=\"25 \">" + listEntry.armor + "</span><hr>";
    ...
    for (let index = 0; index < list.length; index += 2) {
        for (let i = 0; i < jsonHeroSkills.length; i++) {
            if (jsonHeroSkills[i].id === list[index].slug) {
                ...
                var smallIcon = document.createElement("img");
                smallIcon.setAttribute("src", "/evolved/Icons/Abilities/" + jsonHeroSkills[i].icon + ".png");
                smallIcon.setAttribute("width", "20px");
                spell.appendChild(smallIcon);
                spell.appendChild(text);
                upradesoverviewHolder.append(spell);
...
function ShowPassivesOverview(list) {
    ...
    for (let index = 0; index < list.length; index += 2) {
        ...
        text.innerHTML = list[index].name;
        // var smallIcon = document.createElement("img");
        // smallIcon.setAttribute("src", "/evolved/Icons/Abilities/" + jsonHeroSkills[index].icon + ".png");
        // smallIcon.setAttribute("width", "20px");
        //    spell.appendChild(smallIcon);
        spell.appendChild(text);
        upradesoverviewHolder.append(spell);
